...
const Profile = ({ navigation,userInfo }) => {
	...
	return (
		<View style={styles.mainView}>
			...
			/>
			<ScrollView>
			<View style={{ width: 100, height: 100, backgroundColor: "#1a1a1a", alignSelf: "center", 
			justifyContent: "center", alignItems: "center", borderColor: "#FFF",
			 borderWidth: 1, marginTop: 20, marginBottom: 30, borderRadius: 30 }}>
			...
			<View style={{ flexDirection: "row", justifyContent: "space-around" }}>
				<TouchableOpacity
					onPress={() => navigationToFavouritePage()}
				>
			...
			<View style={{ flexDirection: "row", justifyContent: "space-around" }}>
				<TouchableOpacity
					onPress={() => navigationToMovieRequest()}
				>
					<View style={styles.listing}>
						<MovieRequestSvg />
			...
			<View style={{ flexDirection: "row", justifyContent: "space-around" }}>
				<TouchableOpacity
					onPress={() => navigationToMovieReport()}
				>
					<View style={styles.listing}>
						<ReportSvg />
